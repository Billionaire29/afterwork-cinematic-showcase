    ...
    <>
      ...
      >
        <nav className="container flex items-center justify-between h-16 md:h-20">
          ...
          <ul className="hidden md:flex items-center gap-10">
            {links.map((l) => (
              <li key={l.href}>
                <a
                  href={l.href}
                  className="font-mono-ui text-xs uppercase tracking-widest text-white/70 hover:text-lime transition-colors"
                >
                  {l.label}
                </a>
              </li>
          ...
          <div className="hidden md:flex items-center gap-3 font-mono-ui text-[11px] uppercase tracking-widest text-white/70">
        ...
        {open && (
          ...
          >
            <div className="container flex items-center justify-between h-16">
              ...
              <button onClick={() => setOpen(false)} aria-label="Close menu" className="text-white"><X /></button>
            </div>
              ...
              {links.map((l, i) => (
                ...
                >
                  <a
                    ...
                    className="font-display text-5xl text-white hover:text-lime transition-colors"
                  >
                    {l.label}
                  </a>
                </motion.li>
            ...
            <div className="container py-8 flex items-center gap-3 font-mono-ui text-xs uppercase text-white/60">
              <span className="w-2 h-2 rounded-full bg-lime animate-blink" />
              Available for projects
            </div>
          </motion.div>
