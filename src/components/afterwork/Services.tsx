...
const Icon1 = () => (
  <svg width="40" height="40" viewBox="0 0 48 48" fill="none" stroke="#D81E36" strokeWidth="1.5">
...
const Icon3 = () => (
  <svg width="40" height="40" viewBox="0 0 48 48" fill="none" stroke="#D81E36" strokeWidth="1.5">
    ...
    <rect x="26" y="26" width="16" height="16" rx="2" fill="#D81E36" />
  </svg>
);
const Icon4 = () => (
  <svg width="40" height="40" viewBox="0 0 48 48" fill="none" stroke="#D81E36" strokeWidth="1.5">
          ...
          {services.map(({ Icon, title, desc }, i) => (
            ...
            >
              <div className="flex items-start justify-between">
                <Icon />
                <span className="font-mono-ui text-[10px] uppercase tracking-widest text-ink/30">0{i + 1}</span>
              </div>
